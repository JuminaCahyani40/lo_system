...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM data_lube_oil2 WHERE id='$id'";
        ...
        <div class="form-input">
            ...
            <input type="hidden" name="id" value="<?php echo htmlspecialchars($oilData['id']); ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="oilId" class="form-control" id="oilId" placeholder="Masukkan ID Oil" value="<?php echo htmlspecialchars($oilData['id_lube_oil']); ?>">
                </div>
                <div class="mb-2">
                    ...
                    <select class="form-select bg-white" name="select_car" id="select_car" required>
                        ...
                        while ($row = mysqli_fetch_assoc($dataMobil)) {
                            $selected = ($row['id'] == $oilData['id_mobil']) ? 'selected' : '';
                            echo "<option value='{$row['id']}' $selected>{$row['nama_mobil']}</option>";
                        }
                        ?>
                    </select>

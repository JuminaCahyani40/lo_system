...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (empty($_POST["oilId"])) {
        $error_id = "Masukkan Id Mobil.";
    } else {
        $id = cek_input($_POST["oilId"]);
    }

    if (empty($_POST["oilName"])) {
        $error_nama = "Masukkan Nama Mobil";
    } else {
        $nama = cek_input($_POST["oilName"]);
    }

    if (empty($_POST["select_car"]) || $_POST["select_car"] == "Silahkan Pilih Mobil") {
      $error_car = "Pilih Mobil";
    } else {
      $selected_car = cek_input($_POST["select_car"]);
    }
}
    ...
    <div class="container-fluid py-2">
      <!-- write content here -->
        <div class="form-input">
            <form action="proses_data_lo.php" method="post">
                <div class="form-group">
                    <label for="oilId" class="font-weight-bold text-uppercase">Id Oil</label>
                    <input type="text" name="oilId" class="form-control" id="oilId" placeholder="Masukkan ID Oil">
                </div>
                <div class="mb-2">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="oilName" class="form-control" id="oilName" placeholder="Masukkan Nama Lube Oil">
                </div>
